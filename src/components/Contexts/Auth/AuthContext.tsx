...
export type AuthContextType = {
  ...
  signin: (email: string, senha: string ) => Promise<boolean>; // função pra fazer o login, vc manda email e senha e ela vai retornar true or false, se deu certo ou se não deu certo a requisição.
